...
public final class q1 extends p1 {
    ...
    static {
        Covode.recordClassIndex(611626);
        D = 8;
    }
    ...
    public q1(long j, int i, String bookId, String chapterId, int i2, int i3, int i4, int i5, int i6, String chapterVersion, String content, String chapterTitle, String volumeName, boolean z, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, long j2, int i15, boolean z2, long j3, int i16, String notes) {
