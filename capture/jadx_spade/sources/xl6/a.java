...
@XBridgeMethod(name = "original.appendVideoWorkList", owner = "wangsheng.5")
/* loaded from: D:\code\hongguo\capture\classes16.dex */
public final class a extends wl6.a {
    static {
        Covode.recordClassIndex(656091);
    }
    ...
    public void handle(IBDXBridgeContext bridgeContext, a.b params, CompletionBlock<a.c> callback) {
        ...
        if (a != null) {
            a.handleAppendVideoWorkList(bridgeContext, params, callback);
        }
    }
}
