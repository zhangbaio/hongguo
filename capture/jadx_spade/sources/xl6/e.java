...
@XBridgeMethod(name = "original.previewVideo", owner = "")
/* loaded from: D:\code\hongguo\capture\classes16.dex */
public final class e extends wl6.e {
    static {
        Covode.recordClassIndex(656096);
    }
    ...
    public void handle(IBDXBridgeContext bridgeContext, e.b params, CompletionBlock<e.c> callback) {
        ...
        if (a != null) {
            a.handlePreviewVideo(bridgeContext, params, callback);
        }
    }
}
