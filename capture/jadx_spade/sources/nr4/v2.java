...
public final class v2 implements u2 {
    ...
    private final EntityInsertionAdapter<lr4.v0> b;
    private final EntityDeletionOrUpdateAdapter<lr4.v0> c;
    private final SharedSQLiteStatement d;

    static {
        Covode.recordClassIndex(611742);
    }
    ...
    public List<lr4.v0> g() {
        ...
        boolean z;
        String string7;
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT * FROM reader_underline_local", 0);
        ...
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    arrayList.add(new lr4.v0(j, i4, string, string2, i5, i6, i7, i8, i9, string3, string4, string5, string6, i10, i13, i15, i17, i19, i21, i23, i25, j2, i28, z, j3, i31, string7));
    ...
    public int b(String str) {
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT COUNT(*) FROM reader_underline_local WHERE book_id =? AND underline_type=1", 1);
        if (str == null) {
            acquire.bindNull(1);
        } else {
            acquire.bindString(1, str);
    ...
    @Override // nr4.u2
    public void c(List<lr4.v0> list) {
        this.a.assertNotSuspendingTransaction();
        this.a.beginTransaction();
        try {
    ...
    public int d(String str) {
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT COUNT(*) FROM reader_underline_local WHERE book_id =? AND underline_type=0", 1);
        if (str == null) {
            acquire.bindNull(1);
        } else {
            acquire.bindString(1, str);
    ...
    @Override // nr4.u2
    public List<Long> f(List<lr4.v0> list) {
        this.a.assertNotSuspendingTransaction();
        this.a.beginTransaction();
        try {
    ...
    @Override // nr4.u2
    public List<lr4.v0> e(String str) {
        RoomSQLiteQuery roomSQLiteQuery;
        ...
        boolean z;
        String string7;
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT * FROM reader_underline_local WHERE book_id = ?", 1);
        if (str == null) {
            acquire.bindNull(1);
        } else {
            acquire.bindString(1, str);
    ...
    class a extends EntityInsertionAdapter<lr4.v0> {
        ...
        public void bind(SupportSQLiteStatement supportSQLiteStatement, lr4.v0 v0Var) {
            supportSQLiteStatement.bindLong(1, v0Var.a);
            supportSQLiteStatement.bindLong(2, v0Var.b);
            String str = v0Var.c;
            if (str == null) {
            ...
            supportSQLiteStatement.bindLong(5, v0Var.e);
            supportSQLiteStatement.bindLong(6, v0Var.f);
            supportSQLiteStatement.bindLong(7, v0Var.g);
            supportSQLiteStatement.bindLong(8, v0Var.h);
            supportSQLiteStatement.bindLong(9, v0Var.i);
            String str3 = v0Var.j;
            if (str3 == null) {
            ...
            supportSQLiteStatement.bindLong(14, v0Var.n);
            supportSQLiteStatement.bindLong(15, v0Var.o);
            supportSQLiteStatement.bindLong(16, v0Var.p);
            supportSQLiteStatement.bindLong(17, v0Var.q);
            supportSQLiteStatement.bindLong(18, v0Var.r);
            supportSQLiteStatement.bindLong(19, v0Var.s);
            supportSQLiteStatement.bindLong(20, v0Var.t);
            supportSQLiteStatement.bindLong(21, v0Var.u);
            supportSQLiteStatement.bindLong(22, v0Var.v);
            supportSQLiteStatement.bindLong(23, v0Var.w);
            supportSQLiteStatement.bindLong(24, v0Var.x ? 1L : 0L);
            supportSQLiteStatement.bindLong(25, v0Var.y);
            supportSQLiteStatement.bindLong(26, v0Var.z);
            String str7 = v0Var.A;
            if (str7 == null) {
    ...
    class b extends EntityDeletionOrUpdateAdapter<lr4.v0> {
        public String createQuery() {
            return "DELETE FROM `reader_underline_local` WHERE `id` = ?";
        }
    ...
    class c extends SharedSQLiteStatement {
        public String createQuery() {
            return "DELETE FROM reader_underline_local WHERE book_id = ?";
        }
