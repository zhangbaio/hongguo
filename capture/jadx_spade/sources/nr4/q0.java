...
public final class q0 implements n0 {
    ...
    static {
        Covode.recordClassIndex(611674);
    }
    ...
    public List<lr4.t> a() {
        ...
        Cursor query = DBUtil.query(q0Var.a, acquire, false, (CancellationSignal) null);
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    tVar.j(q0Var.k(query.getString(columnIndexOrThrow8)));
                    ...
                    tVar.q(q0Var.m(query.getString(i10)));
        ...
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    tVar.q(q0Var.m(query.getString(i11)));
    ...
    class a extends EntityInsertionAdapter<lr4.t> {
        ...
        public void bind(SupportSQLiteStatement supportSQLiteStatement, lr4.t tVar) {
            ...
            if (bookType == null) {
                ...
                supportSQLiteStatement.bindString(8, q0.this.j(bookType));
            }
            ...
            if (genreTypeEnum == null) {
                ...
                supportSQLiteStatement.bindString(16, q0.this.l(genreTypeEnum));
            }
