...
public final class x2 implements w2 {
    ...
    private final EntityInsertionAdapter<lr4.w0> b;
    private final EntityDeletionOrUpdateAdapter<lr4.w0> c;
    private final EntityDeletionOrUpdateAdapter<lr4.w0> d;
    private final SharedSQLiteStatement e;
    private final SharedSQLiteStatement f;

    static {
        Covode.recordClassIndex(611745);
    }
    ...
    public List<lr4.w0> j() {
        ...
        boolean z2;
        String string7;
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT * FROM reader_underline_remote WHERE is_deleted = 1", 0);
        ...
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    arrayList.add(new lr4.w0(j, i4, string, string2, i5, i6, i7, i8, i9, string3, string4, string5, string6, z, i12, i14, i16, i18, i20, i22, i24, i26, j2, i29, z2, j3, i32, string7));
    ...
    public int b(String str) {
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT COUNT(*) FROM reader_underline_remote WHERE book_id =? AND is_deleted = 0 AND underline_type=1", 1);
        if (str == null) {
            acquire.bindNull(1);
        } else {
            acquire.bindString(1, str);
    ...
    public int d(String str) {
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT COUNT(*) FROM reader_underline_remote WHERE book_id =? AND is_deleted = 0 AND underline_type=0", 1);
        if (str == null) {
            acquire.bindNull(1);
        } else {
            acquire.bindString(1, str);
    ...
    public List<lr4.w0> h(String str) {
        ...
        boolean z2;
        String string7;
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT * FROM reader_underline_remote WHERE book_id = ? AND is_deleted = 1", 1);
        if (str == null) {
            acquire.bindNull(1);
        } else {
            acquire.bindString(1, str);
    ...
    public List<lr4.w0> i(String str) {
        ...
        boolean z2;
        String string7;
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT * FROM reader_underline_remote WHERE book_id = ? AND is_deleted = 0", 1);
        if (str == null) {
            acquire.bindNull(1);
        } else {
            acquire.bindString(1, str);
    ...
    class a extends EntityInsertionAdapter<lr4.w0> {
        ...
        public void bind(SupportSQLiteStatement supportSQLiteStatement, lr4.w0 w0Var) {
            supportSQLiteStatement.bindLong(1, w0Var.a);
            ...
            supportSQLiteStatement.bindLong(5, w0Var.e);
            supportSQLiteStatement.bindLong(6, w0Var.f);
            supportSQLiteStatement.bindLong(7, w0Var.g);
            supportSQLiteStatement.bindLong(8, w0Var.h);
            supportSQLiteStatement.bindLong(9, w0Var.i);
            String str3 = w0Var.j;
            if (str3 == null) {
            ...
            supportSQLiteStatement.bindLong(14, w0Var.n ? 1L : 0L);
            supportSQLiteStatement.bindLong(15, w0Var.o);
            supportSQLiteStatement.bindLong(16, w0Var.p);
            supportSQLiteStatement.bindLong(17, w0Var.q);
            supportSQLiteStatement.bindLong(18, w0Var.r);
            supportSQLiteStatement.bindLong(19, w0Var.s);
            supportSQLiteStatement.bindLong(20, w0Var.t);
            supportSQLiteStatement.bindLong(21, w0Var.u);
            supportSQLiteStatement.bindLong(22, w0Var.v);
            supportSQLiteStatement.bindLong(23, w0Var.w);
            supportSQLiteStatement.bindLong(24, w0Var.x);
            supportSQLiteStatement.bindLong(25, w0Var.y ? 1L : 0L);
            supportSQLiteStatement.bindLong(26, w0Var.z);
    ...
    class b extends EntityDeletionOrUpdateAdapter<lr4.w0> {
        public String createQuery() {
            return "DELETE FROM `reader_underline_remote` WHERE `mark_id` = ?";
        }
    ...
    class c extends EntityDeletionOrUpdateAdapter<lr4.w0> {
        public String createQuery() {
            return "UPDATE OR ABORT `reader_underline_remote` SET `mark_id` = ?,`mark_type` = ?,`book_id` = ?,`chapter_id` = ?,`chapter_index` = ?,`start_para_id` = ?,`start_offset_in_para` = ?,`end_para_id` = ?,`end_offset_in_para` = ?,`chapter_version` = ?,`content` = ?,`chapter_title` = ?,`volume_name` = ?,`is_deleted` = ?,`start_container_id` = ?,`start_element_index` = ?,`start_element_offset` = ?,`end_container_id` = ?,`end_element_index` = ?,`end_element_offset` = ?,`start_order` = ?,`end_order` = ?,`modify_time` = ?,`line_type` = ?,`is_public` = ?,`hot_line_id` = ?,`underline_type` = ?,`notes` = ? WHERE `mark_id` = ?";
        }
        ...
        public void bind(SupportSQLiteStatement supportSQLiteStatement, lr4.w0 w0Var) {
            ...
            supportSQLiteStatement.bindLong(29, w0Var.a);
        }
    }

    class d extends SharedSQLiteStatement {
        public String createQuery() {
            return "DELETE FROM reader_underline_remote WHERE book_id = ? AND is_deleted = 0";
        }
    ...
    class e extends SharedSQLiteStatement {
        public String createQuery() {
            return "DELETE FROM reader_underline_remote WHERE book_id = ?";
        }
