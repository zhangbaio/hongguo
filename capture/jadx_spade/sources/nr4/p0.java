...
public final class p0 implements n0 {
    ...
    private final EntityInsertionAdapter<lr4.t> b;

    static {
        Covode.recordClassIndex(611673);
    }
    ...
    public List<lr4.t> a() {
        ...
        p0Var.a.assertNotSuspendingTransaction();
        Cursor query = DBUtil.query(p0Var.a, acquire, false, (CancellationSignal) null);
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    lr4.t tVar = new lr4.t();
                    int i3 = columnIndexOrThrow11;
                    int i4 = columnIndexOrThrow12;
                    tVar.a = query.getLong(columnIndexOrThrow);
                    ...
                    tVar.o(string3);
                    tVar.f = query.getInt(columnIndexOrThrow6);
                    tVar.g = query.getFloat(columnIndexOrThrow7);
                    tVar.j(p0Var.k(query.getString(columnIndexOrThrow8)));
                    tVar.i = query.getLong(columnIndexOrThrow9);
                    tVar.j = query.getFloat(columnIndexOrThrow10);
                    ...
                    tVar.m = query.getInt(i6);
                    int i8 = columnIndexOrThrow14;
                    tVar.n = query.getInt(i8);
                    int i9 = columnIndexOrThrow15;
                    tVar.o = query.getInt(i9);
                    int i10 = columnIndexOrThrow16;
                    tVar.q(p0Var.m(query.getString(i10)));
                    int i11 = columnIndexOrThrow17;
                    int i12 = columnIndexOrThrow3;
                    tVar.q = query.getLong(i11);
                    ...
                    tVar.t = query.getDouble(i15);
                    int i16 = columnIndexOrThrow21;
                    tVar.u = query.getInt(i16);
                    int i17 = columnIndexOrThrow22;
                    tVar.v = query.getLong(i17);
                    columnIndexOrThrow22 = i17;
                    int i18 = columnIndexOrThrow23;
                    tVar.w = query.getLong(i18);
                    columnIndexOrThrow23 = i18;
                    int i19 = columnIndexOrThrow24;
                    tVar.x = query.getLong(i19);
                    columnIndexOrThrow24 = i19;
                    int i20 = columnIndexOrThrow25;
                    tVar.y = query.getLong(i20);
                    arrayList.add(tVar);
    ...
    public Long[] h(lr4.t... tVarArr) {
        this.a.assertNotSuspendingTransaction();
        this.a.beginTransaction();
        try {
            Long[] insertAndReturnIdsArrayBox = this.b.insertAndReturnIdsArrayBox(tVarArr);
    ...
    @Override // nr4.n0
    public List<lr4.t> b(List<String> list) {
        RoomSQLiteQuery roomSQLiteQuery;
        String string;
        String string2;
        String string3;
        ...
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    tVar.m = query.getInt(i7);
                    int i9 = columnIndexOrThrow14;
                    tVar.n = query.getInt(i9);
                    int i10 = columnIndexOrThrow15;
                    tVar.o = query.getInt(i10);
                    int i11 = columnIndexOrThrow16;
                    tVar.q(p0Var.m(query.getString(i11)));
                    int i12 = columnIndexOrThrow17;
                    int i13 = columnIndexOrThrow3;
                    tVar.q = query.getLong(i12);
                    ...
                    tVar.t = query.getDouble(i16);
                    int i17 = columnIndexOrThrow21;
                    tVar.u = query.getInt(i17);
                    int i18 = columnIndexOrThrow22;
                    tVar.v = query.getLong(i18);
                    columnIndexOrThrow22 = i18;
                    int i19 = columnIndexOrThrow23;
                    tVar.w = query.getLong(i19);
                    columnIndexOrThrow23 = i19;
                    int i20 = columnIndexOrThrow24;
                    tVar.x = query.getLong(i20);
                    columnIndexOrThrow24 = i20;
                    int i21 = columnIndexOrThrow25;
                    tVar.y = query.getLong(i21);
                    arrayList.add(tVar);
    ...
    @Override // nr4.n0
    public List<lr4.t> d(String str) {
        RoomSQLiteQuery roomSQLiteQuery;
        String string;
        String string2;
        String string3;
    ...
    class a extends EntityInsertionAdapter<lr4.t> {
        ...
        public void bind(SupportSQLiteStatement supportSQLiteStatement, lr4.t tVar) {
            ...
            supportSQLiteStatement.bindDouble(7, tVar.g);
            BookType bookType = tVar.h;
            if (bookType == null) {
                supportSQLiteStatement.bindNull(8);
            } else {
                supportSQLiteStatement.bindString(8, p0.this.j(bookType));
            }
            supportSQLiteStatement.bindLong(9, tVar.i);
            supportSQLiteStatement.bindDouble(10, tVar.j);
            supportSQLiteStatement.bindLong(11, tVar.k);
            supportSQLiteStatement.bindLong(12, tVar.l);
            ...
            GenreTypeEnum genreTypeEnum = tVar.p;
            if (genreTypeEnum == null) {
                supportSQLiteStatement.bindNull(16);
            } else {
                supportSQLiteStatement.bindString(16, p0.this.l(genreTypeEnum));
            }
            ...
            supportSQLiteStatement.bindDouble(20, tVar.t);
            supportSQLiteStatement.bindLong(21, tVar.u);
            supportSQLiteStatement.bindLong(22, tVar.v);
            supportSQLiteStatement.bindLong(23, tVar.w);
            supportSQLiteStatement.bindLong(24, tVar.x);
            supportSQLiteStatement.bindLong(25, tVar.y);
        }
    }

    @Override // nr4.n0
    public lr4.t c(String str, String str2) {
        RoomSQLiteQuery roomSQLiteQuery;
        lr4.t tVar;
        String string;
        String string2;
        ...
        try {
            ...
            try {
                ...
                if (query.moveToFirst()) {
                    lr4.t tVar2 = new lr4.t();
                    tVar2.a = query.getLong(columnIndexOrThrow);
                    if (query.isNull(columnIndexOrThrow2)) {
                        string = null;
                    } else {
                        string = query.getString(columnIndexOrThrow2);
                    ...
                    tVar2.k(string2);
                    tVar2.d = query.getInt(columnIndexOrThrow4);
                    if (query.isNull(columnIndexOrThrow5)) {
                        string3 = null;
                    } else {
                        string3 = query.getString(columnIndexOrThrow5);
                    ...
                    tVar2.o(string3);
                    tVar2.f = query.getInt(columnIndexOrThrow6);
                    tVar2.g = query.getFloat(columnIndexOrThrow7);
                    tVar2.j(k(query.getString(columnIndexOrThrow8)));
                    tVar2.i = query.getLong(columnIndexOrThrow9);
                    tVar2.j = query.getFloat(columnIndexOrThrow10);
                    tVar2.k = query.getInt(columnIndexOrThrow11);
                    tVar2.l = query.getInt(columnIndexOrThrow12);
                    tVar2.m = query.getInt(columnIndexOrThrow13);
                    tVar2.n = query.getInt(columnIndexOrThrow14);
                    tVar2.o = query.getInt(columnIndexOrThrow15);
                    tVar2.q(m(query.getString(columnIndexOrThrow16)));
                    tVar2.q = query.getLong(columnIndexOrThrow17);
                    ...
                    tVar2.n(string5);
                    tVar2.t = query.getDouble(columnIndexOrThrow20);
                    tVar2.u = query.getInt(columnIndexOrThrow21);
                    tVar2.v = query.getLong(columnIndexOrThrow22);
                    tVar2.w = query.getLong(columnIndexOrThrow23);
                    tVar2.x = query.getLong(columnIndexOrThrow24);
                    tVar2.y = query.getLong(columnIndexOrThrow25);
                    tVar = tVar2;
                } else {
                    tVar = null;
                }
