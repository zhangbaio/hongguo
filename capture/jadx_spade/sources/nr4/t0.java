...
public final class t0 implements r0 {
    ...
    private final EntityInsertionAdapter<lr4.u> b;

    static {
        Covode.recordClassIndex(611677);
    }
    ...
    public List<lr4.u> a() {
        ...
        String string5;
        t0 t0Var = this;
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT * FROM t_chapter_read_progress", 0);
        t0Var.a.assertNotSuspendingTransaction();
        Cursor query = DBUtil.query(t0Var.a, acquire, false, (CancellationSignal) null);
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    lr4.u uVar = new lr4.u();
                    int i3 = columnIndexOrThrow11;
                    int i4 = columnIndexOrThrow12;
                    uVar.a = query.getLong(columnIndexOrThrow);
                    ...
                    uVar.k(string2);
                    uVar.d = query.getInt(columnIndexOrThrow4);
                    ...
                    uVar.o(string3);
                    uVar.f = query.getInt(columnIndexOrThrow6);
                    uVar.g = query.getFloat(columnIndexOrThrow7);
                    uVar.j(t0Var.k(query.getString(columnIndexOrThrow8)));
                    uVar.i = query.getLong(columnIndexOrThrow9);
                    uVar.j = query.getFloat(columnIndexOrThrow10);
                    columnIndexOrThrow11 = i3;
                    uVar.k = query.getInt(columnIndexOrThrow11);
                    int i5 = columnIndexOrThrow;
                    columnIndexOrThrow12 = i4;
                    uVar.l = query.getInt(columnIndexOrThrow12);
                    int i6 = i2;
                    int i7 = columnIndexOrThrow2;
                    uVar.m = query.getInt(i6);
                    int i8 = columnIndexOrThrow14;
                    uVar.n = query.getInt(i8);
                    int i9 = columnIndexOrThrow15;
                    uVar.o = query.getInt(i9);
                    int i10 = columnIndexOrThrow16;
                    uVar.q(t0Var.m(query.getString(i10)));
                    int i11 = columnIndexOrThrow17;
                    int i12 = columnIndexOrThrow3;
                    uVar.q = query.getLong(i11);
                    ...
                    uVar.t = query.getDouble(i15);
                    int i16 = columnIndexOrThrow21;
                    uVar.u = query.getInt(i16);
                    int i17 = columnIndexOrThrow22;
                    uVar.v = query.getLong(i17);
                    columnIndexOrThrow22 = i17;
                    int i18 = columnIndexOrThrow23;
                    uVar.w = query.getLong(i18);
                    columnIndexOrThrow23 = i18;
                    int i19 = columnIndexOrThrow24;
                    uVar.x = query.getLong(i19);
                    columnIndexOrThrow24 = i19;
                    int i20 = columnIndexOrThrow25;
                    uVar.y = query.getLong(i20);
                    arrayList.add(uVar);
    ...
    public List<lr4.u> e() {
        ...
        String string5;
        t0 t0Var = this;
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT * FROM t_chapter_read_progress WHERE update_state = 0", 0);
        t0Var.a.assertNotSuspendingTransaction();
        Cursor query = DBUtil.query(t0Var.a, acquire, false, (CancellationSignal) null);
        try {
            int columnIndexOrThrow = CursorUtil.getColumnIndexOrThrow(query, "create_timestamp_ms");
    ...
    public Long[] h(lr4.u... uVarArr) {
        this.a.assertNotSuspendingTransaction();
        this.a.beginTransaction();
        try {
            Long[] insertAndReturnIdsArrayBox = this.b.insertAndReturnIdsArrayBox(uVarArr);
    ...
    @Override // nr4.r0
    public List<lr4.u> b(List<String> list) {
        RoomSQLiteQuery roomSQLiteQuery;
        String string;
        String string2;
        String string3;
        ...
        newStringBuilder.append("SELECT * FROM t_chapter_read_progress WHERE book_id IN (");
        int size = list.size();
        ...
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    uVar.m = query.getInt(i7);
                    int i9 = columnIndexOrThrow14;
                    uVar.n = query.getInt(i9);
                    int i10 = columnIndexOrThrow15;
                    uVar.o = query.getInt(i10);
                    int i11 = columnIndexOrThrow16;
                    uVar.q(t0Var.m(query.getString(i11)));
                    int i12 = columnIndexOrThrow17;
                    int i13 = columnIndexOrThrow3;
                    uVar.q = query.getLong(i12);
                    ...
                    uVar.t = query.getDouble(i16);
                    int i17 = columnIndexOrThrow21;
                    uVar.u = query.getInt(i17);
                    int i18 = columnIndexOrThrow22;
                    uVar.v = query.getLong(i18);
                    columnIndexOrThrow22 = i18;
                    int i19 = columnIndexOrThrow23;
                    uVar.w = query.getLong(i19);
                    columnIndexOrThrow23 = i19;
                    int i20 = columnIndexOrThrow24;
                    uVar.x = query.getLong(i20);
                    columnIndexOrThrow24 = i20;
                    int i21 = columnIndexOrThrow25;
                    uVar.y = query.getLong(i21);
                    arrayList.add(uVar);
    ...
    @Override // nr4.r0
    public List<lr4.u> d(String str) {
        RoomSQLiteQuery roomSQLiteQuery;
        String string;
        String string2;
        String string3;
        ...
        String string5;
        t0 t0Var = this;
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT * FROM t_chapter_read_progress WHERE book_id = ?", 1);
        if (str == null) {
            acquire.bindNull(1);
        } else {
    ...
    class a extends EntityInsertionAdapter<lr4.u> {
        public String createQuery() {
            return "INSERT OR REPLACE INTO `t_chapter_read_progress` (`create_timestamp_ms`,`book_id`,`chapter_id`,`chapter_index`,`chapter_title`,`page_index`,`total_chapter_count_progress_rate`,`book_type`,`ms_timestamp`,`short_story_pager_progress_rate`,`paragraph_id`,`line_in_paragraph_offset`,`start_container_index`,`start_element_index`,`start_element_offset`,`genre_type`,`tone_id`,`chapter_recent_read_progress_rate`,`chapter_show_read_progress_rate`,`book_page_progress`,`update_state`,`channel_id`,`cur_channel_id`,`duration`,`start_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        }
        ...
        public void bind(SupportSQLiteStatement supportSQLiteStatement, lr4.u uVar) {
            ...
            supportSQLiteStatement.bindDouble(7, uVar.g);
            BookType bookType = uVar.h;
            if (bookType == null) {
                supportSQLiteStatement.bindNull(8);
            } else {
                supportSQLiteStatement.bindString(8, t0.this.j(bookType));
            }
            supportSQLiteStatement.bindLong(9, uVar.i);
            supportSQLiteStatement.bindDouble(10, uVar.j);
            supportSQLiteStatement.bindLong(11, uVar.k);
            supportSQLiteStatement.bindLong(12, uVar.l);
            supportSQLiteStatement.bindLong(13, uVar.m);
            supportSQLiteStatement.bindLong(14, uVar.n);
            supportSQLiteStatement.bindLong(15, uVar.o);
            GenreTypeEnum genreTypeEnum = uVar.p;
            if (genreTypeEnum == null) {
                supportSQLiteStatement.bindNull(16);
            } else {
                supportSQLiteStatement.bindString(16, t0.this.l(genreTypeEnum));
            }
            ...
            supportSQLiteStatement.bindDouble(20, uVar.t);
            supportSQLiteStatement.bindLong(21, uVar.u);
    ...
    @Override // nr4.r0
    public lr4.u c(String str, String str2) {
        RoomSQLiteQuery roomSQLiteQuery;
        lr4.u uVar;
        String string;
        String string2;
        ...
        String string4;
        String string5;
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT * FROM t_chapter_read_progress WHERE book_id = ? AND chapter_id = ?", 2);
        if (str == null) {
            acquire.bindNull(1);
        } else {
            acquire.bindString(1, str);
        ...
        try {
            ...
            try {
                ...
                if (query.moveToFirst()) {
                    lr4.u uVar2 = new lr4.u();
                    uVar2.a = query.getLong(columnIndexOrThrow);
                    if (query.isNull(columnIndexOrThrow2)) {
                        string = null;
                    } else {
                        string = query.getString(columnIndexOrThrow2);
                    ...
                    uVar2.k(string2);
                    uVar2.d = query.getInt(columnIndexOrThrow4);
                    if (query.isNull(columnIndexOrThrow5)) {
                        string3 = null;
                    } else {
                        string3 = query.getString(columnIndexOrThrow5);
                    ...
                    uVar2.o(string3);
                    uVar2.f = query.getInt(columnIndexOrThrow6);
                    uVar2.g = query.getFloat(columnIndexOrThrow7);
                    uVar2.j(k(query.getString(columnIndexOrThrow8)));
                    uVar2.i = query.getLong(columnIndexOrThrow9);
                    uVar2.j = query.getFloat(columnIndexOrThrow10);
                    uVar2.k = query.getInt(columnIndexOrThrow11);
                    uVar2.l = query.getInt(columnIndexOrThrow12);
                    uVar2.m = query.getInt(columnIndexOrThrow13);
                    uVar2.n = query.getInt(columnIndexOrThrow14);
                    uVar2.o = query.getInt(columnIndexOrThrow15);
                    uVar2.q(m(query.getString(columnIndexOrThrow16)));
                    uVar2.q = query.getLong(columnIndexOrThrow17);
                    ...
                    uVar2.n(string5);
                    uVar2.t = query.getDouble(columnIndexOrThrow20);
                    uVar2.u = query.getInt(columnIndexOrThrow21);
                    uVar2.v = query.getLong(columnIndexOrThrow22);
                    uVar2.w = query.getLong(columnIndexOrThrow23);
                    uVar2.x = query.getLong(columnIndexOrThrow24);
                    uVar2.y = query.getLong(columnIndexOrThrow25);
                    uVar = uVar2;
                } else {
                    uVar = null;
                }
