...
public final class u0 implements r0 {
    ...
    public List<lr4.u> a() {
        ...
        u0Var.a.assertNotSuspendingTransaction();
        Cursor query = DBUtil.query(u0Var.a, acquire, false, (CancellationSignal) null);
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    uVar.j(u0Var.k(query.getString(columnIndexOrThrow8)));
                    ...
                    uVar.q(u0Var.m(query.getString(i10)));
        ...
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    uVar.q(u0Var.m(query.getString(i11)));
    ...
    class a extends EntityInsertionAdapter<lr4.u> {
        ...
        public void bind(SupportSQLiteStatement supportSQLiteStatement, lr4.u uVar) {
            ...
            if (bookType == null) {
                ...
                supportSQLiteStatement.bindString(8, u0.this.j(bookType));
            }
            ...
            if (genreTypeEnum == null) {
                ...
                supportSQLiteStatement.bindString(16, u0.this.l(genreTypeEnum));
            }
