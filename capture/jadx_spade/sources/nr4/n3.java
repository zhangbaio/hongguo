...
public final class n3 implements j3 {
    ...
    public List<lr4.c1> a() {
        ...
        n3Var.a.assertNotSuspendingTransaction();
        Cursor query = DBUtil.query(n3Var.a, acquire, false, (CancellationSignal) null);
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    c1Var.j(n3Var.k(query.getString(columnIndexOrThrow8)));
                    ...
                    c1Var.q(n3Var.m(query.getString(i10)));
        ...
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    c1Var.q(n3Var.m(query.getString(i11)));
    ...
    class a extends EntityInsertionAdapter<lr4.c1> {
        ...
        public void bind(SupportSQLiteStatement supportSQLiteStatement, lr4.c1 c1Var) {
            ...
            if (bookType == null) {
                ...
                supportSQLiteStatement.bindString(8, n3.this.j(bookType));
            }
            ...
            if (genreTypeEnum == null) {
                ...
                supportSQLiteStatement.bindString(16, n3.this.l(genreTypeEnum));
            }
