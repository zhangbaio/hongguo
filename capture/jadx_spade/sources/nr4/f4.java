...
public final class f4 implements d4 {
    ...
    private final EntityInsertionAdapter<lr4.i1> b;
    private final EntityDeletionOrUpdateAdapter<lr4.i1> c;
    ...
    public List<lr4.i1> c() {
        ...
        try {
            ...
            while (query.moveToNext()) {
                ...
                arrayList.add(new lr4.i1(string, query.getLong(columnIndexOrThrow2)));
            }
            return arrayList;
        } finally {
            query.close();
    ...
    public Long[] k(lr4.i1... i1VarArr) {
        ...
        this.a.beginTransaction();
        try {
            Long[] insertAndReturnIdsArrayBox = this.b.insertAndReturnIdsArrayBox(i1VarArr);
            this.a.setTransactionSuccessful();
    ...
    public int l(lr4.i1... i1VarArr) {
        ...
        this.a.beginTransaction();
        try {
            int handleMultiple = this.c.handleMultiple(i1VarArr) + 0;
            this.a.setTransactionSuccessful();
    ...
    class a extends EntityInsertionAdapter<lr4.i1> {
        ...
        public void bind(SupportSQLiteStatement supportSQLiteStatement, lr4.i1 i1Var) {
            String str = i1Var.a;
            if (str == null) {
            ...
            supportSQLiteStatement.bindLong(2, i1Var.b);
        }
    }

    class b extends EntityDeletionOrUpdateAdapter<lr4.i1> {
        public String createQuery() {
