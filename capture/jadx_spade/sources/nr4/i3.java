...
public final class i3 implements e3 {
    ...
    private final EntityInsertionAdapter<lr4.b1> b;

    static {
        Covode.recordClassIndex(611756);
    }
    ...
    public lr4.b1 i() {
        ...
        String string4;
        String string5;
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT * FROM t_recent_book_listen_progress ORDER BY ms_timestamp DESC LIMIT 1", 0);
        ...
        try {
            ...
            if (query.moveToFirst()) {
                lr4.b1 b1Var2 = new lr4.b1();
                b1Var2.a = query.getLong(columnIndexOrThrow);
                ...
                b1Var2.k(string2);
                b1Var2.d = query.getInt(columnIndexOrThrow4);
                ...
                b1Var2.o(string3);
                b1Var2.f = query.getInt(columnIndexOrThrow6);
                b1Var2.g = query.getFloat(columnIndexOrThrow7);
                b1Var2.j(k(query.getString(columnIndexOrThrow8)));
                b1Var2.i = query.getLong(columnIndexOrThrow9);
                b1Var2.j = query.getFloat(columnIndexOrThrow10);
                b1Var2.k = query.getInt(columnIndexOrThrow11);
                b1Var2.l = query.getInt(columnIndexOrThrow12);
                b1Var2.m = query.getInt(columnIndexOrThrow13);
                b1Var2.n = query.getInt(columnIndexOrThrow14);
                b1Var2.o = query.getInt(columnIndexOrThrow15);
                b1Var2.q(m(query.getString(columnIndexOrThrow16)));
                b1Var2.q = query.getLong(columnIndexOrThrow17);
                ...
                b1Var2.n(string5);
                b1Var2.t = query.getDouble(columnIndexOrThrow20);
                b1Var2.u = query.getInt(columnIndexOrThrow21);
                b1Var2.v = query.getLong(columnIndexOrThrow22);
                b1Var2.w = query.getLong(columnIndexOrThrow23);
                b1Var2.x = query.getLong(columnIndexOrThrow24);
                b1Var2.y = query.getLong(columnIndexOrThrow25);
                b1Var = b1Var2;
            } else {
                b1Var = null;
            }
    ...
    public List<lr4.b1> a() {
        ...
        String string5;
        i3 i3Var = this;
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT * FROM t_recent_book_listen_progress ", 0);
        i3Var.a.assertNotSuspendingTransaction();
        Cursor query = DBUtil.query(i3Var.a, acquire, false, (CancellationSignal) null);
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    b1Var.k(string2);
                    b1Var.d = query.getInt(columnIndexOrThrow4);
                    if (query.isNull(columnIndexOrThrow5)) {
                        string3 = null;
                    } else {
                        string3 = query.getString(columnIndexOrThrow5);
                    ...
                    b1Var.o(string3);
                    b1Var.f = query.getInt(columnIndexOrThrow6);
                    b1Var.g = query.getFloat(columnIndexOrThrow7);
                    b1Var.j(i3Var.k(query.getString(columnIndexOrThrow8)));
                    b1Var.i = query.getLong(columnIndexOrThrow9);
                    b1Var.j = query.getFloat(columnIndexOrThrow10);
                    columnIndexOrThrow11 = i3;
                    b1Var.k = query.getInt(columnIndexOrThrow11);
                    int i5 = columnIndexOrThrow;
                    columnIndexOrThrow12 = i4;
                    b1Var.l = query.getInt(columnIndexOrThrow12);
                    int i6 = i2;
                    int i7 = columnIndexOrThrow2;
                    b1Var.m = query.getInt(i6);
                    int i8 = columnIndexOrThrow14;
                    b1Var.n = query.getInt(i8);
                    int i9 = columnIndexOrThrow15;
                    b1Var.o = query.getInt(i9);
                    int i10 = columnIndexOrThrow16;
                    b1Var.q(i3Var.m(query.getString(i10)));
                    int i11 = columnIndexOrThrow17;
                    int i12 = columnIndexOrThrow3;
                    b1Var.q = query.getLong(i11);
                    ...
                    b1Var.t = query.getDouble(i15);
                    int i16 = columnIndexOrThrow21;
                    b1Var.u = query.getInt(i16);
                    int i17 = columnIndexOrThrow22;
                    b1Var.v = query.getLong(i17);
                    columnIndexOrThrow22 = i17;
                    int i18 = columnIndexOrThrow23;
                    b1Var.w = query.getLong(i18);
                    columnIndexOrThrow23 = i18;
                    int i19 = columnIndexOrThrow24;
                    b1Var.x = query.getLong(i19);
                    columnIndexOrThrow24 = i19;
                    int i20 = columnIndexOrThrow25;
                    b1Var.y = query.getLong(i20);
                    arrayList.add(b1Var);
    ...
    public Long[] h(lr4.b1... b1VarArr) {
        this.a.assertNotSuspendingTransaction();
        this.a.beginTransaction();
        try {
            Long[] insertAndReturnIdsArrayBox = this.b.insertAndReturnIdsArrayBox(b1VarArr);
    ...
    public lr4.b1 f(String str) {
        ...
        String string4;
        String string5;
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT * FROM t_recent_book_listen_progress WHERE book_id = ?", 1);
        if (str == null) {
            acquire.bindNull(1);
        } else {
    ...
    @Override // nr4.e3
    public List<lr4.b1> g(List<String> list) {
        RoomSQLiteQuery roomSQLiteQuery;
        String string;
        String string2;
        String string3;
        ...
        newStringBuilder.append("SELECT * FROM t_recent_book_listen_progress WHERE book_id IN (");
        int size = list.size();
        ...
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    b1Var.m = query.getInt(i7);
                    int i9 = columnIndexOrThrow14;
                    b1Var.n = query.getInt(i9);
                    int i10 = columnIndexOrThrow15;
                    b1Var.o = query.getInt(i10);
                    int i11 = columnIndexOrThrow16;
                    b1Var.q(i3Var.m(query.getString(i11)));
                    int i12 = columnIndexOrThrow17;
                    int i13 = columnIndexOrThrow3;
                    b1Var.q = query.getLong(i12);
                    ...
                    b1Var.t = query.getDouble(i16);
                    int i17 = columnIndexOrThrow21;
                    b1Var.u = query.getInt(i17);
                    int i18 = columnIndexOrThrow22;
                    b1Var.v = query.getLong(i18);
                    columnIndexOrThrow22 = i18;
                    int i19 = columnIndexOrThrow23;
                    b1Var.w = query.getLong(i19);
                    columnIndexOrThrow23 = i19;
                    int i20 = columnIndexOrThrow24;
                    b1Var.x = query.getLong(i20);
                    columnIndexOrThrow24 = i20;
                    int i21 = columnIndexOrThrow25;
                    b1Var.y = query.getLong(i21);
                    arrayList.add(b1Var);
    ...
    class a extends EntityInsertionAdapter<lr4.b1> {
        public String createQuery() {
            return "INSERT OR REPLACE INTO `t_recent_book_listen_progress` (`create_timestamp_ms`,`book_id`,`chapter_id`,`chapter_index`,`chapter_title`,`page_index`,`total_chapter_count_progress_rate`,`book_type`,`ms_timestamp`,`short_story_pager_progress_rate`,`paragraph_id`,`line_in_paragraph_offset`,`start_container_index`,`start_element_index`,`start_element_offset`,`genre_type`,`tone_id`,`chapter_recent_read_progress_rate`,`chapter_show_read_progress_rate`,`book_page_progress`,`update_state`,`channel_id`,`cur_channel_id`,`duration`,`start_time`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        }
        ...
        public void bind(SupportSQLiteStatement supportSQLiteStatement, lr4.b1 b1Var) {
            supportSQLiteStatement.bindLong(1, b1Var.a);
            String str = b1Var.b;
            if (str == null) {
            ...
            supportSQLiteStatement.bindLong(4, b1Var.d);
            String str3 = b1Var.e;
            if (str3 == null) {
            ...
            supportSQLiteStatement.bindLong(6, b1Var.f);
            supportSQLiteStatement.bindDouble(7, b1Var.g);
            BookType bookType = b1Var.h;
            if (bookType == null) {
                supportSQLiteStatement.bindNull(8);
            } else {
                supportSQLiteStatement.bindString(8, i3.this.j(bookType));
            }
            supportSQLiteStatement.bindLong(9, b1Var.i);
            supportSQLiteStatement.bindDouble(10, b1Var.j);
            supportSQLiteStatement.bindLong(11, b1Var.k);
            supportSQLiteStatement.bindLong(12, b1Var.l);
            supportSQLiteStatement.bindLong(13, b1Var.m);
            supportSQLiteStatement.bindLong(14, b1Var.n);
            supportSQLiteStatement.bindLong(15, b1Var.o);
            GenreTypeEnum genreTypeEnum = b1Var.p;
            if (genreTypeEnum == null) {
                supportSQLiteStatement.bindNull(16);
            } else {
                supportSQLiteStatement.bindString(16, i3.this.l(genreTypeEnum));
            }
            supportSQLiteStatement.bindLong(17, b1Var.q);
            String str4 = b1Var.r;
            if (str4 == null) {
            ...
            supportSQLiteStatement.bindDouble(20, b1Var.t);
            supportSQLiteStatement.bindLong(21, b1Var.u);
            supportSQLiteStatement.bindLong(22, b1Var.v);
            supportSQLiteStatement.bindLong(23, b1Var.w);
            supportSQLiteStatement.bindLong(24, b1Var.x);
            supportSQLiteStatement.bindLong(25, b1Var.y);
        }
    }
}
