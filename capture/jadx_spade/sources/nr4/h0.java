...
public final class h0 implements f0 {
    ...
    private final EntityInsertionAdapter<lr4.o> b;
    private final EntityDeletionOrUpdateAdapter<lr4.o> c;
    private final EntityDeletionOrUpdateAdapter<lr4.o> d;
        ...
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    oVar.f = query.getInt(columnIndexOrThrow6);
                    oVar.g = query.getInt(columnIndexOrThrow7);
                    oVar.h = query.getInt(columnIndexOrThrow8);
                    oVar.i = query.getInt(columnIndexOrThrow9);
                    if (query.isNull(columnIndexOrThrow10)) {
                        oVar.j = null;
                    } else {
                        oVar.j = query.getString(columnIndexOrThrow10);
                    }
                    if (query.isNull(columnIndexOrThrow11)) {
                        oVar.k = null;
                    } else {
                        oVar.k = query.getString(columnIndexOrThrow11);
                    }
                    if (query.isNull(columnIndexOrThrow12)) {
                        oVar.l = null;
                    } else {
                        oVar.l = query.getString(columnIndexOrThrow12);
                    }
                    if (query.isNull(i3)) {
                        oVar.m = null;
                    } else {
    ...
    public List<lr4.o> j() {
        ...
        int i;
        boolean z;
        RoomSQLiteQuery acquire = RoomSQLiteQuery.acquire("SELECT * FROM t_bookmark_remote", 0);
        this.a.assertNotSuspendingTransaction();
        Cursor query = DBUtil.query(this.a, acquire, false, (CancellationSignal) null);
        try {
            int columnIndexOrThrow = CursorUtil.getColumnIndexOrThrow(query, "mark_id");
        ...
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    oVar.p = query.getInt(i8);
                    int i9 = columnIndexOrThrow17;
                    oVar.q = query.getInt(i9);
                    int i10 = columnIndexOrThrow18;
                    oVar.r = query.getInt(i10);
                    int i11 = columnIndexOrThrow19;
                    oVar.s = query.getInt(i11);
                    int i12 = columnIndexOrThrow20;
                    oVar.t = query.getInt(i12);
                    int i13 = columnIndexOrThrow21;
                    oVar.u = query.getInt(i13);
                    int i14 = columnIndexOrThrow22;
                    oVar.v = query.getInt(i14);
                    int i15 = columnIndexOrThrow23;
                    oVar.w = query.getInt(i15);
                    int i16 = columnIndexOrThrow24;
                    oVar.x = query.getInt(i16);
                    int i17 = columnIndexOrThrow25;
                    oVar.y = query.getLong(i17);
                    arrayList.add(oVar);
    ...
    class a extends EntityInsertionAdapter<lr4.o> {
        ...
        public void bind(SupportSQLiteStatement supportSQLiteStatement, lr4.o oVar) {
            ...
            supportSQLiteStatement.bindLong(14, oVar.n ? 1L : 0L);
            ...
            supportSQLiteStatement.bindLong(22, oVar.v);
    ...
    class b extends EntityDeletionOrUpdateAdapter<lr4.o> {
        public String createQuery() {
    ...
    class c extends EntityDeletionOrUpdateAdapter<lr4.o> {
        public String createQuery() {
        ...
        public void bind(SupportSQLiteStatement supportSQLiteStatement, lr4.o oVar) {
            ...
            supportSQLiteStatement.bindLong(24, oVar.x);
            supportSQLiteStatement.bindLong(25, oVar.y);
            supportSQLiteStatement.bindLong(26, oVar.a);
        }
    }
