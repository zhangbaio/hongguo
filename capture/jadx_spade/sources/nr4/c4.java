...
public final class c4 implements a4 {
    ...
    private final EntityInsertionAdapter<lr4.f1> b;
    private final EntityDeletionOrUpdateAdapter<lr4.f1> c;
    ...
    public List<lr4.f1> c() {
        ...
        try {
            ...
            while (query.moveToNext()) {
                ...
                arrayList.add(new lr4.f1(string, query.getLong(columnIndexOrThrow2)));
            }
            return arrayList;
        } finally {
            query.close();
    ...
    public int g(lr4.f1... f1VarArr) {
        ...
        this.a.beginTransaction();
        try {
            int handleMultiple = this.c.handleMultiple(f1VarArr) + 0;
            this.a.setTransactionSuccessful();
    ...
    public Long[] n(lr4.f1... f1VarArr) {
        ...
        this.a.beginTransaction();
        try {
            Long[] insertAndReturnIdsArrayBox = this.b.insertAndReturnIdsArrayBox(f1VarArr);
            this.a.setTransactionSuccessful();
    ...
    class a extends EntityInsertionAdapter<lr4.f1> {
        ...
        public void bind(SupportSQLiteStatement supportSQLiteStatement, lr4.f1 f1Var) {
            String str = f1Var.a;
            if (str == null) {
            ...
            supportSQLiteStatement.bindLong(2, f1Var.b);
        }
    }

    class b extends EntityDeletionOrUpdateAdapter<lr4.f1> {
        public String createQuery() {
