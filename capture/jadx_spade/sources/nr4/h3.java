...
public final class h3 implements e3 {
    ...
    static {
        Covode.recordClassIndex(611755);
    }
    ...
    public List<lr4.b1> a() {
        ...
        h3Var.a.assertNotSuspendingTransaction();
        Cursor query = DBUtil.query(h3Var.a, acquire, false, (CancellationSignal) null);
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    b1Var.j(h3Var.k(query.getString(columnIndexOrThrow8)));
                    ...
                    b1Var.q(h3Var.m(query.getString(i10)));
        ...
        try {
            ...
            try {
                ...
                while (query.moveToNext()) {
                    ...
                    b1Var.q(h3Var.m(query.getString(i11)));
    ...
    class a extends EntityInsertionAdapter<lr4.b1> {
        ...
        public void bind(SupportSQLiteStatement supportSQLiteStatement, lr4.b1 b1Var) {
            ...
            if (bookType == null) {
                ...
                supportSQLiteStatement.bindString(8, h3.this.j(bookType));
            }
            ...
            if (genreTypeEnum == null) {
                ...
                supportSQLiteStatement.bindString(16, h3.this.l(genreTypeEnum));
            }
