package com.dragon.read.nps.impl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    private static class b {
        ...
        static {
            Covode.recordClassIndex(612562);
            a = new HashMap<>(0);
        }
    }

    static {
        Covode.recordClassIndex(612560);
    ...
    private static class a {
        ...
        static {
            Covode.recordClassIndex(612561);
    ...
    public List<DataBinderMapper> collectDependencies() {
        ...
        arrayList.add(new com.bytedance.ug.sdk.novel.progress.DataBinderMapperImpl());
        ...
        arrayList.add(new com.dragon.read.nps.api.DataBinderMapperImpl());
