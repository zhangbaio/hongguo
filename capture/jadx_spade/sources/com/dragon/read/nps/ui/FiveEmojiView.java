...
public final class FiveEmojiView extends ConstraintLayout implements INpsViewProxy {
    ...
    static {
        Covode.recordClassIndex(612564);
        l = 8;
    }
    ...
    private final void S1() {
        int i = 0;
        this.k[0] = findViewById(2131826160);
        this.k[1] = findViewById(2131825597);
        this.k[2] = findViewById(2131826300);
        this.k[3] = findViewById(2131831700);
        this.k[4] = findViewById(2131826161);
        NpsEmojiView[] npsEmojiViewArr = this.k;
        int length = npsEmojiViewArr.length;
        final int i2 = 0;
        while (i < length) {
            final NpsEmojiView npsEmojiView = npsEmojiViewArr[i];
            int i3 = i2 + 1;
            if (npsEmojiView != null) {
                npsEmojiView.setOnClickListener(new View.OnClickListener() { // from class: com.dragon.read.nps.ui.b
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        FiveEmojiView.T1(FiveEmojiView.this, i2, npsEmojiView, view);
                    }
                });
            }
            i++;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public FiveEmojiView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
        Intrinsics.checkNotNullParameter(context, "context");
        this.i = true;
        this.j = true;
        this.k = new NpsEmojiView[5];
        ViewGroup.inflate(context, 2131038493, this);
        V1();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void T1(FiveEmojiView fiveEmojiView, int i, NpsEmojiView npsEmojiView, View view) {
        if (!fiveEmojiView.j) {
            return;
        }
        if (fiveEmojiView.i) {
        ...
        INpsViewProxy.IOnSelectChanged iOnSelectChanged = fiveEmojiView.g;
