...
public final class ReaderApiService$getFull$$inlined$invoke$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ReaderApiService$getFull$$inlined$invoke$1(Ref$ObjectRef ref$ObjectRef, com.bytedance.multi.rpc.core.proxy.c cVar, com.bytedance.multi.rpc.core.proxy.a aVar, zn0.g gVar, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ReaderApiService$getFull$$inlined$invoke$1(this.$iHttpResponse, this.$req, this.this$0, this.$config, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ReaderApiService$getFull$$inlined$invoke$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
