...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    private static class b {
        ...
        static {
            Covode.recordClassIndex(612452);
            a = new HashMap<>(0);
        }
    }

    static {
        Covode.recordClassIndex(612450);
    ...
    private static class a {
        ...
        static {
            Covode.recordClassIndex(612451);
    ...
    public List<DataBinderMapper> collectDependencies() {
        ...
        arrayList.add(new com.dragon.read.feed.DataBinderMapperImpl());
        ...
        arrayList.add(new com.dragon.read.nonstandard.ad.api.DataBinderMapperImpl());
