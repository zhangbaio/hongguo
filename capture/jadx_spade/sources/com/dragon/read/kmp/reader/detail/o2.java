...
public final class o2 {
    ...
    public final Function3<androidx.compose.foundation.lazy.f, Composer, Integer, Unit> c() {
        return d;
    }
    ...
    static {
        ...
        a = new o2();
        b = androidx.compose.runtime.internal.t.c(-1393951009, false, a.a);
        c = androidx.compose.runtime.internal.t.c(-2010033049, false, b.a);
        d = androidx.compose.runtime.internal.t.c(-369729084, false, c.a);
    }
        ...
        public final void a(Composer composer, int i) {
            ...
            if (composer.shouldExecute(z, i & 1)) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-1393951009, i, -1, "com.dragon.read.kmp.reader.detail.ComposableSingletons$BookDetailPageKt.lambda$-1393951009.<anonymous> (BookDetailPage.kt:341)");
                }
                Modifier d = BackgroundKt.d(SizeKt.f(Modifier.Companion, 0.0f, 1, (Object) null), og4.a.a.c().b(composer, og4.a.b).b(), (androidx.compose.ui.graphics.f2) null, 2, (Object) null);
    ...
    static final class c implements Function3<androidx.compose.foundation.lazy.f, Composer, Integer, Unit> {
        ...
        public final void a(androidx.compose.foundation.lazy.f item, Composer composer, int i) {
            ...
            if (composer.shouldExecute(z, i & 1)) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-369729084, i, -1, "com.dragon.read.kmp.reader.detail.ComposableSingletons$BookDetailPageKt.lambda$-369729084.<anonymous> (BookDetailPage.kt:560)");
                }
                a3.a(SizeKt.i(Modifier.Companion, x0.i.g(88)), composer, 6);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                    return;
                }
    ...
    static final class b implements Function5<Integer, String, Function0<? extends Unit>, Composer, Integer, Unit> {
        ...
        public final void a(int i, String msg, Function0<Unit> retry, Composer composer, int i2) {
            ...
            if (composer.shouldExecute(z, i2 & 1)) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-2010033049, i2, -1, "com.dragon.read.kmp.reader.detail.ComposableSingletons$BookDetailPageKt.lambda$-2010033049.<anonymous> (BookDetailPage.kt:346)");
                }
                Modifier d = BackgroundKt.d(SizeKt.f(Modifier.Companion, 0.0f, 1, (Object) null), og4.a.a.c().b(composer, og4.a.b).b(), (androidx.compose.ui.graphics.f2) null, 2, (Object) null);
