...
public class ActivityClientControllerProxy extends AbsObjectProxy implements OnHookInstall {
    static {
        Covode.recordClassIndex(653745);
    }

    private static Object com_tencent_tinker_lib_hook_ActivityClientControllerProxy_java_lang_reflect_Method_invoke(Method method, Object obj, Object[] objArr) {
    ...
    public void onHookInstall() {
        ...
        try {
            ...
            if (Class.forName("android.util.Singleton").isInstance(readStaticField)) {
                ...
                if (readField == null) {
                    readField = com_tencent_tinker_lib_hook_ActivityClientControllerProxy_java_lang_reflect_Method_invoke(MethodUtils.getAccessibleMethod(readStaticField.getClass(), "get", new Class[0]), readStaticField, new Object[0]);
                }
                if (readField != null) {
                    setTarget(readField);
                    ...
                    AbsObjectProxy.sDelegateMethods.put("overridePendingTransition", new OverridePendingTransition("Mute.ActClientCtlProxy"));
