...
public interface ConstantsAPI {
    ...
    public static final class AppSupportContentFlag {
        ...
        static {
            Covode.recordClassIndex(653281);
        }
    }
    ...
    public static final class LaunchApplication {
        ...
        static {
            Covode.recordClassIndex(653282);
        }
    }
    ...
    public static final class LaunchWX {
        ...
        static {
            Covode.recordClassIndex(653283);
        }
    }
    ...
    public interface OpenWebviewType {
        ...
        static {
            Covode.recordClassIndex(653284);
        }
    }
    ...
    public static final class Token {
        ...
        static {
            Covode.recordClassIndex(653285);
        }
    }
    ...
    public static final class WXApp {
        ...
        static {
            Covode.recordClassIndex(653286);
        }
    }
    ...
    public static final class WXMiniProgram {
        ...
        static {
            Covode.recordClassIndex(653287);
        }
    }
    ...
    public static final class WXWebPage {
        ...
        static {
            Covode.recordClassIndex(653288);
        }
    }

    static {
        Covode.recordClassIndex(653280);
    }
}
