...
public class AddCardToWXCardPackage {
    ...
    public static class Req extends BaseReq {
        ...
        static {
            Covode.recordClassIndex(653305);
        }
    ...
    public static class Resp extends BaseResp {
        ...
        static {
            Covode.recordClassIndex(653306);
        }
        ...
        public void fromBundle(Bundle bundle) {
            ...
            try {
                ...
                Log.e("MicroMsg.AddCardToWXCardPackage", "fromBundle exception: " + e.getMessage());
            }
        }
    ...
    public static final class WXCardItem {
        ...
        static {
            Covode.recordClassIndex(653307);
        }
    }

    static {
        Covode.recordClassIndex(653304);
    }
}
