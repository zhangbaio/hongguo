...
public final class MaybeFlatMapSingleElement<T, R> extends Maybe<R> {
    ...
    static {
        Covode.recordClassIndex(656964);
    }
    ...
    static final class FlatMapMaybeObserver<T, R> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
        ...
        static {
            Covode.recordClassIndex(656965);
        }
        ...
        public void onSuccess(T t) {
            try {
                ((SingleSource) ObjectHelper.requireNonNull(this.mapper.apply(t), "The mapper returned a null SingleSource")).subscribe(new a(this, this.downstream));
            } catch (Throwable th) {
    ...
    static final class a<R> implements SingleObserver<R> {
        ...
        static {
            Covode.recordClassIndex(656966);
        }
