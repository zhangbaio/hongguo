...
public final class SingleFlatMapIterableFlowable<T, R> extends Flowable<R> {
    ...
    static {
        Covode.recordClassIndex(657576);
    }
    ...
    static final class FlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R> implements SingleObserver<T> {
        ...
        volatile Iterator<? extends R> f1045it;
        ...
        static {
            Covode.recordClassIndex(657577);
        }
        ...
        public R poll() throws Exception {
            Iterator<? extends R> it2 = this.f1045it;
            if (it2 == null) {
                return null;
            }
