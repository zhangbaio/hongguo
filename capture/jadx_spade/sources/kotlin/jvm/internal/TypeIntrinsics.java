...
public class TypeIntrinsics {
    static {
        Covode.recordClassIndex(658569);
    }
    ...
    public static boolean isMutableMapEntry(Object obj) {
        if ((obj instanceof Map.Entry) && (!(obj instanceof KMappedMarker) || (obj instanceof KMutableMap.a))) {
            return true;
        }
        return false;
    }
    ...
    public static Map.Entry asMutableMapEntry(Object obj) {
        if ((obj instanceof KMappedMarker) && !(obj instanceof KMutableMap.a)) {
