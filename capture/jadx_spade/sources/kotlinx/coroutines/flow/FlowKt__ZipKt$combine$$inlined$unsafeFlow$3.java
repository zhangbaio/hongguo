...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$3<R> implements Flow<R> {
    ...
    public Object collect(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        ...
        Function0<T[]> function0 = new Function0<T[]>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$6$1
        ...
        Intrinsics.needClassReification();
        Object a = CombineKt.a(flowCollector, flowArr, function0, new FlowKt__ZipKt$combine$6$2(this.b, null), continuation);
