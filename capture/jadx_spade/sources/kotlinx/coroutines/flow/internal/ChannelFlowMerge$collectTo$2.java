...
final class ChannelFlowMerge$collectTo$2<T> implements FlowCollector {
    ...
    ChannelFlowMerge$collectTo$2(Job job, Semaphore semaphore, ProducerScope<? super T> producerScope, n<T> nVar) {
        this.a = job;
        this.b = semaphore;
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        AnonymousClass1(Flow<? extends T> flow, n<T> nVar, Semaphore semaphore, Continuation<? super AnonymousClass1> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (i != 0) {
                    ...
                    n<T> nVar = this.$collector;
                    this.label = 1;
                    if (flow.collect(nVar, this) == coroutine_suspended) {
    ...
    */
    public final java.lang.Object emit(kotlinx.coroutines.flow.Flow<? extends T> r8, kotlin.coroutines.Continuation<? super kotlin.Unit> r9) {
        ...
        L53:
            ...
            kotlinx.coroutines.flow.internal.n<T> r9 = r0.d
