...
final class PublisherAsFlow$collectSlowPath$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    PublisherAsFlow$collectSlowPath$2(FlowCollector<? super T> flowCollector, PublisherAsFlow<T> publisherAsFlow, Continuation<? super PublisherAsFlow$collectSlowPath$2> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            ReceiveChannel i2 = channelFlow.i(CoroutineScopeKt.plus(coroutineScope, channelFlow.a));
            this.label = 1;
