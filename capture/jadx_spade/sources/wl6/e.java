...
public abstract class e extends XCoreIDLBridgeMethod<b, c> {
    ...
    @XBridgeMethodName(name = "original.previewVideo", params = {"path"})
    private final String a = "original.previewVideo";
    ...
    public static final class a {
        static {
            Covode.recordClassIndex(656068);
        }
    ...
    static {
        ...
        Covode.recordClassIndex(656067);
        c = new a(null);
        mapOf = MapsKt__MapsJVMKt.mapOf(TuplesKt.to("TicketID", "37947"));
        d = mapOf;
    }
}
